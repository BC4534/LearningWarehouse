...
# 将修改后的内容写回 txt 文件
with open('户外柜国际化_replace6.2.txt', 'w', encoding='utf-8') as txt_file:
    txt_file.writelines(lines)

# 将匹配上的词条写入新的 txt 文件
with open('户外柜国际化_replace6.5.txt', 'w', encoding='utf-8') as txt_file:
    txt_file.writelines(matched_lines)

# 将匹配不上的词条写入新的 txt 文件
with open('unmatched_entries6.5.txt', 'w', encoding='utf-8') as txt_file:
